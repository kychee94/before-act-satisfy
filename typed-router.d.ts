...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-agent': RouteRecordInfo<'admin-agent', '/admin/agent', Record<never, never>, Record<never, never>>,
    ...
    'admin-brand': RouteRecordInfo<'admin-brand', '/admin/brand', Record<never, never>, Record<never, never>>,
    'admin-brand-create': RouteRecordInfo<'admin-brand-create', '/admin/brand/create', Record<never, never>, Record<never, never>>,
    'admin-brand-edit': RouteRecordInfo<'admin-brand-edit', '/admin/brand/edit', Record<never, never>, Record<never, never>>,
    'admin-brand-sort': RouteRecordInfo<'admin-brand-sort', '/admin/brand/sort', Record<never, never>, Record<never, never>>,
    'admin-category': RouteRecordInfo<'admin-category', '/admin/category', Record<never, never>, Record<never, never>>,
    'admin-category-sort': RouteRecordInfo<'admin-category-sort', '/admin/category/sort', Record<never, never>, Record<never, never>>,
    'admin-checkin': RouteRecordInfo<'admin-checkin', '/admin/checkin', Record<never, never>, Record<never, never>>,
    'admin-checkin-member': RouteRecordInfo<'admin-checkin-member', '/admin/checkin/member', Record<never, never>, Record<never, never>>,
    'admin-checkin-setting-checkin': RouteRecordInfo<'admin-checkin-setting-checkin', '/admin/checkin/setting/checkin', Record<never, never>, Record<never, never>>,
    'admin-checkin-setting-setting': RouteRecordInfo<'admin-checkin-setting-setting', '/admin/checkin/setting/setting', Record<never, never>, Record<never, never>>,
    'admin-chest': RouteRecordInfo<'admin-chest', '/admin/chest', Record<never, never>, Record<never, never>>,
    'admin-chest-setting-chest': RouteRecordInfo<'admin-chest-setting-chest', '/admin/chest/setting/chest', Record<never, never>, Record<never, never>>,
    'admin-chest-setting-setting': RouteRecordInfo<'admin-chest-setting-setting', '/admin/chest/setting/setting', Record<never, never>, Record<never, never>>,
    'Dashboard': RouteRecordInfo<'Dashboard', '/admin/dashboard', Record<never, never>, Record<never, never>>,
    'Dashboard': RouteRecordInfo<'Dashboard', '/admin/dashboard_template', Record<never, never>, Record<never, never>>,
    'admin-member': RouteRecordInfo<'admin-member', '/admin/member', Record<never, never>, Record<never, never>>,
    'admin-member-create': RouteRecordInfo<'admin-member-create', '/admin/member/create', Record<never, never>, Record<never, never>>,
    'admin-member-edit': RouteRecordInfo<'admin-member-edit', '/admin/member/edit', Record<never, never>, Record<never, never>>,
    'admin-member-exchange': RouteRecordInfo<'admin-member-exchange', '/admin/member/exchange', Record<never, never>, Record<never, never>>,
    'admin-order': RouteRecordInfo<'admin-order', '/admin/order', Record<never, never>, Record<never, never>>,
    'admin-order-edit': RouteRecordInfo<'admin-order-edit', '/admin/order/edit', Record<never, never>, Record<never, never>>,
    'admin-product': RouteRecordInfo<'admin-product', '/admin/product', Record<never, never>, Record<never, never>>,
    'admin-product-category': RouteRecordInfo<'admin-product-category', '/admin/product/category', Record<never, never>, Record<never, never>>,
    'admin-product-create': RouteRecordInfo<'admin-product-create', '/admin/product/create', Record<never, never>, Record<never, never>>,
    'admin-product-edit': RouteRecordInfo<'admin-product-edit', '/admin/product/edit', Record<never, never>, Record<never, never>>,
    'admin-product-sort': RouteRecordInfo<'admin-product-sort', '/admin/product/sort', Record<never, never>, Record<never, never>>,
    'admin-scratchcard': RouteRecordInfo<'admin-scratchcard', '/admin/scratchcard', Record<never, never>, Record<never, never>>,
    'admin-scratchcard-setting-scratchcard': RouteRecordInfo<'admin-scratchcard-setting-scratchcard', '/admin/scratchcard/setting/scratchcard', Record<never, never>, Record<never, never>>,
    'admin-scratchcard-setting-setting': RouteRecordInfo<'admin-scratchcard-setting-setting', '/admin/scratchcard/setting/setting', Record<never, never>, Record<never, never>>,
    'admin-setting-design': RouteRecordInfo<'admin-setting-design', '/admin/setting/design', Record<never, never>, Record<never, never>>,
    'admin-setting-design-fab': RouteRecordInfo<'admin-setting-design-fab', '/admin/setting/design/fab', Record<never, never>, Record<never, never>>,
    'admin-setting-email': RouteRecordInfo<'admin-setting-email', '/admin/setting/email', Record<never, never>, Record<never, never>>,
    'admin-setting-email-listing': RouteRecordInfo<'admin-setting-email-listing', '/admin/setting/email/listing', Record<never, never>, Record<never, never>>,
    'admin-setting-email-setting': RouteRecordInfo<'admin-setting-email-setting', '/admin/setting/email/setting', Record<never, never>, Record<never, never>>,
    'admin-setting-ipblocked': RouteRecordInfo<'admin-setting-ipblocked', '/admin/setting/ipblocked', Record<never, never>, Record<never, never>>,
    'admin-setting-layout': RouteRecordInfo<'admin-setting-layout', '/admin/setting/layout', Record<never, never>, Record<never, never>>,
    'admin-setting-layout-company': RouteRecordInfo<'admin-setting-layout-company', '/admin/setting/layout/company', Record<never, never>, Record<never, never>>,
    'admin-setting-layout-general': RouteRecordInfo<'admin-setting-layout-general', '/admin/setting/layout/general', Record<never, never>, Record<never, never>>,
    'admin-setting-layout-notice': RouteRecordInfo<'admin-setting-layout-notice', '/admin/setting/layout/notice', Record<never, never>, Record<never, never>>,
    'admin-setting-log-system': RouteRecordInfo<'admin-setting-log-system', '/admin/setting/log/system', Record<never, never>, Record<never, never>>,
    'admin-setting-marketing': RouteRecordInfo<'admin-setting-marketing', '/admin/setting/marketing', Record<never, never>, Record<never, never>>,
    'admin-setting-marketing-ads': RouteRecordInfo<'admin-setting-marketing-ads', '/admin/setting/marketing/ads', Record<never, never>, Record<never, never>>,
    'admin-setting-marketing-analytics': RouteRecordInfo<'admin-setting-marketing-analytics', '/admin/setting/marketing/analytics', Record<never, never>, Record<never, never>>,
    'admin-setting-marketing-seo': RouteRecordInfo<'admin-setting-marketing-seo', '/admin/setting/marketing/seo', Record<never, never>, Record<never, never>>,
    'admin-setting-marketing-social': RouteRecordInfo<'admin-setting-marketing-social', '/admin/setting/marketing/social', Record<never, never>, Record<never, never>>,
    'admin-setting-page': RouteRecordInfo<'admin-setting-page', '/admin/setting/page', Record<never, never>, Record<never, never>>,
    'admin-setting-page-create': RouteRecordInfo<'admin-setting-page-create', '/admin/setting/page/create', Record<never, never>, Record<never, never>>,
    'admin-setting-page-edit': RouteRecordInfo<'admin-setting-page-edit', '/admin/setting/page/edit', Record<never, never>, Record<never, never>>,
    'admin-setting-slideshow': RouteRecordInfo<'admin-setting-slideshow', '/admin/setting/slideshow', Record<never, never>, Record<never, never>>,
    'admin-setting-slideshow-create': RouteRecordInfo<'admin-setting-slideshow-create', '/admin/setting/slideshow/create', Record<never, never>, Record<never, never>>,
    'admin-setting-slideshow-edit': RouteRecordInfo<'admin-setting-slideshow-edit', '/admin/setting/slideshow/edit', Record<never, never>, Record<never, never>>,
    'admin-smash': RouteRecordInfo<'admin-smash', '/admin/smash', Record<never, never>, Record<never, never>>,
    'admin-smash-setting-setting': RouteRecordInfo<'admin-smash-setting-setting', '/admin/smash/setting/setting', Record<never, never>, Record<never, never>>,
    'admin-smash-setting-smash': RouteRecordInfo<'admin-smash-setting-smash', '/admin/smash/setting/smash', Record<never, never>, Record<never, never>>,
    'admin-spin': RouteRecordInfo<'admin-spin', '/admin/spin', Record<never, never>, Record<never, never>>,
    'admin-spin-setting-segment': RouteRecordInfo<'admin-spin-setting-segment', '/admin/spin/setting/segment', Record<never, never>, Record<never, never>>,
    'admin-spin-setting-setting': RouteRecordInfo<'admin-spin-setting-setting', '/admin/spin/setting/setting', Record<never, never>, Record<never, never>>,
    'admin-transaction-agent': RouteRecordInfo<'admin-transaction-agent', '/admin/transaction/agent', Record<never, never>, Record<never, never>>,
    'admin-transaction-checkin': RouteRecordInfo<'admin-transaction-checkin', '/admin/transaction/checkin', Record<never, never>, Record<never, never>>,
    'admin-transaction-chest': RouteRecordInfo<'admin-transaction-chest', '/admin/transaction/chest', Record<never, never>, Record<never, never>>,
    'admin-transaction-member': RouteRecordInfo<'admin-transaction-member', '/admin/transaction/member', Record<never, never>, Record<never, never>>,
    'admin-transaction-scratchcard': RouteRecordInfo<'admin-transaction-scratchcard', '/admin/transaction/scratchcard', Record<never, never>, Record<never, never>>,
    'admin-transaction-smash': RouteRecordInfo<'admin-transaction-smash', '/admin/transaction/smash', Record<never, never>, Record<never, never>>,
    'admin-transaction-spin': RouteRecordInfo<'admin-transaction-spin', '/admin/transaction/spin', Record<never, never>, Record<never, never>>,
    'admin-user': RouteRecordInfo<'admin-user', '/admin/user', Record<never, never>, Record<never, never>>,
    'admin-user-access': RouteRecordInfo<'admin-user-access', '/admin/user/access', Record<never, never>, Record<never, never>>,
    'admin-user-create': RouteRecordInfo<'admin-user-create', '/admin/user/create', Record<never, never>, Record<never, never>>,
    'admin-user-edit': RouteRecordInfo<'admin-user-edit', '/admin/user/edit', Record<never, never>, Record<never, never>>,
    'admin-user-general': RouteRecordInfo<'admin-user-general', '/admin/user/general', Record<never, never>, Record<never, never>>,
    'admin-user-profile': RouteRecordInfo<'admin-user-profile', '/admin/user/profile', Record<never, never>, Record<never, never>>,
    'admin-user-role': RouteRecordInfo<'admin-user-role', '/admin/user/role', Record<never, never>, Record<never, never>>,
    'admin-voucher': RouteRecordInfo<'admin-voucher', '/admin/voucher', Record<never, never>, Record<never, never>>,
    'admin-voucher-create': RouteRecordInfo<'admin-voucher-create', '/admin/voucher/create', Record<never, never>, Record<never, never>>,
    'apiindex': RouteRecordInfo<'apiindex', '/API/Index', Record<never, never>, Record<never, never>>,
    'apipartials-api-token-manager': RouteRecordInfo<'apipartials-api-token-manager', '/API/Partials/ApiTokenManager', Record<never, never>, Record<never, never>>,
    ...
    'auth-admin-login': RouteRecordInfo<'auth-admin-login', '/auth/admin/login', Record<never, never>, Record<never, never>>,
    ...
    'auth-two-factor-challenge': RouteRecordInfo<'auth-two-factor-challenge', '/auth/TwoFactorChallenge', Record<never, never>, Record<never, never>>,
    ...
    'chest': RouteRecordInfo<'chest', '/chest', Record<never, never>, Record<never, never>>,
    ...
    'errors404': RouteRecordInfo<'errors404', '/errors/404', Record<never, never>, Record<never, never>>,
    'errors500': RouteRecordInfo<'errors500', '/errors/500', Record<never, never>, Record<never, never>>,
    'errors-admin401': RouteRecordInfo<'errors-admin401', '/errors/admin/401', Record<never, never>, Record<never, never>>,
    'errors-admin404': RouteRecordInfo<'errors-admin404', '/errors/admin/404', Record<never, never>, Record<never, never>>,
    '405': RouteRecordInfo<'405', '/errors/admin/405', Record<never, never>, Record<never, never>>,
    'errors-admin500': RouteRecordInfo<'errors-admin500', '/errors/admin/500', Record<never, never>, Record<never, never>>,
    ...
    'privacy-policy': RouteRecordInfo<'privacy-policy', '/PrivacyPolicy', Record<never, never>, Record<never, never>>,
    ...
    'profile-partials-logout-other-browser-sessions-form': RouteRecordInfo<'profile-partials-logout-other-browser-sessions-form', '/Profile/Partials/LogoutOtherBrowserSessionsForm', Record<never, never>, Record<never, never>>,
    'profile-partials-two-factor-authentication-form': RouteRecordInfo<'profile-partials-two-factor-authentication-form', '/Profile/Partials/TwoFactorAuthenticationForm', Record<never, never>, Record<never, never>>,
    ...
    'scratchcard': RouteRecordInfo<'scratchcard', '/scratchcard', Record<never, never>, Record<never, never>>,
    'slideshow': RouteRecordInfo<'slideshow', '/slideshow', Record<never, never>, Record<never, never>>,
    'smash': RouteRecordInfo<'smash', '/smash', Record<never, never>, Record<never, never>>,
    'spin-wheel': RouteRecordInfo<'spin-wheel', '/spin-wheel', Record<never, never>, Record<never, never>>,
    ...
    'terms-of-service': RouteRecordInfo<'terms-of-service', '/TermsOfService', Record<never, never>, Record<never, never>>,
