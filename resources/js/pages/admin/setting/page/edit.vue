...
languages.forEach(lang => {
  page_title[lang.lang_code] = 
    JSON.parse(props.page?.page_title_locale)?.[lang.lang_code] || ''
  imageInput.pc[lang.lang_code] = 
    JSON.parse(props.page?.page_image)?.pc?.[lang.lang_code] || ''
  imageInput.mobile[lang.lang_code] = 
    JSON.parse(props.page?.page_image)?.mobile?.[lang.lang_code] || ''
  page_description[lang.lang_code] = 
    JSON.parse(props.page.page_content_locale)?.[lang.lang_code] || ''
  page_seo_title[lang.lang_code] = 
    JSON.parse(props.page.page_seo_title_locale)?.[lang.lang_code] || ''
  page_seo_keyword[lang.lang_code] = 
    JSON.parse(props.page.page_seo_keyword_locale)?.[lang.lang_code] || ''
  page_seo_description[lang.lang_code] = 
    JSON.parse(props.page.page_seo_description_locale)?.[lang.lang_code] || ''
})
...
const form = useForm({
  ...
  page_url_title: props.page.page_url_title || '',
  page_link: props.page.page_link || '',
  page_template: props.page.page_template || 'Default',
  page_seo_title: page_seo_title,
  page_seo_keyword: page_seo_keyword,
  page_seo_description: page_seo_description,
  page_description: page_description,
  icon: props.page.page_icon,
  iconInput: props.page.page_icon,
  image: imageInput,
  imageInput: imageInput,
  page_status: Boolean(props.page.page_status) || 0,
  page_menu: Boolean(props.page.page_menu) || 0,
  page_login: Boolean(props.page.page_login) || 0,
})
...
const onSubmit = (formRef, formInstance) => {
  formInstance.transform(data => ({
    ...formInstance.data(),
  })).post(route('admin.setting.page.update'), {
      forceFormData: true,
      onStart: () => {
        loadingStore.start()
      },
