...
const res = ref(JSON.parse(JSON.stringify(props.cards)))
...
const fetchData = async () => {
  try {
    var response = await axios.get('/admin/scratchcard?type=getData', {
      params: {
        q: search.value || null,
...
const saveChest = async () => {
  ...
  try {
    ...
    var response = await axios.post('/admin/scratchcard/update', formData, {
      headers: {
          ...
          <VTable 
            ...
            <tbody>
              <tr
                ...
                <td>
                  <VBtn icon="mdi-delete" color="error" variant="text" @click="deleteItem(card.uuid)" />
                </td>
              </tr>
            </tbody>
          </VTable>
