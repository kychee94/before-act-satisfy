...
const res = ref(JSON.parse(JSON.stringify(props.smashes)))
...
const fetchData = async () => {
  try {
    var response = await axios.get('/admin/smash?type=getData', {
      params: {
        q: search.value || null,
    ...
    res.value = response.data.smashes
...
const saveChest = async () => {
  ...
  try {
    ...
    var response = await axios.post('/admin/smash/update', formData, {
      headers: {
              ...
              <tr
                ...
                <td class="text-center">
                  <VImg
                    ...
                    width="100"
                    height="100"
                    @click="openLightbox(smash.imageUrl)"
                  />
                  <input
                    type="file"
                ...
                <td>
                  <VBtn icon="mdi-delete" color="error" variant="text" @click="deleteItem(smash.uuid)" />
                </td>
              </tr>
            </tbody>
          </VTable>
